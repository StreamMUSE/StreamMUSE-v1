...
if [[ "${RUN_PUBLIC_CLIENT}" == "1" ]]; then
  ...
  unset LEKAI_PROMPT_CONTINUATION_RECOVER_LATE_EVENTS
  unset LEKAI_PROMPT_CONTINUATION_BOUND_LATE_RECOVERY
  unset LEKAI_PROMPT_CONTINUATION_RECOVER_LATE_MAX_TICKS
  LEKAI_SERVER_HOST=127.0.0.1 \
