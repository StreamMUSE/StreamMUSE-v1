---
title: 输入模式
description: 四种输入源（keyboard、midi、midi_file、list）的使用说明
---
...
# 指定设备名
uv run streammuse-cli --input-mode midi --midi-device-name "Arturia KeyLab 61"
```
...
通过 CLI 无法直接使用此模式（无对应的 `--input-mode list` 参数，Factory 内部支持）。

---

## 各模式特性对比

| 特性 | keyboard | midi | midi_file | list |
|---|---|---|---|---|
