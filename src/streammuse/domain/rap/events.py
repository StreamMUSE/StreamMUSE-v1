...
class RapEventType(str, Enum):
    ...
    CHUNK_REQUEST_SUBMITTED = "chunk_request_submitted"
    CHUNK_REMOTE_COMPLETED = "chunk_remote_completed"
    CHUNK_REMOTE_REJECTED = "chunk_remote_rejected"
    CHUNK_COMMITTED = "chunk_committed"
    CHUNK_FALLBACK_ACTIVATED = "chunk_fallback_activated"
