...
const PianoVisualizer = (function() {
    ...
    function drawNotes() {
        ...
        for (const note of noteHistory) {
            ...
            const isPast = note.startTick + note.duration < currentTick;
    ...
    function cleanupOldNotes() {
        ...
        while (replacedNotes.length > 0 && replacedNotes[0].startTick + replacedNotes[0].duration < cutoffTick) {
            replacedNotes.shift();
        }
    }
