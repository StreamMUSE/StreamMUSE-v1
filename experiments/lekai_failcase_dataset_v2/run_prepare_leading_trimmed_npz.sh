...
OUTPUT_ROOT="${OUTPUT_ROOT:-/data/home/yuanxin/data/lekai_failcase_dataset_v2_leading_trimmed}"
PYTHON_BIN="${PYTHON_BIN:-python}"
SELECTION_JSONL="${SELECTION_JSONL:-${STREAMMUSE_ROOT}/experiments/lekai_failcase_dataset_v2/provisional_selection.jsonl}"

cd "${STREAMMUSE_ROOT}"
"${PYTHON_BIN}" experiments/lekai_failcase_dataset_v2/prepare_leading_trimmed_npz.py \
